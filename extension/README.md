...
The popup defaults to the production backend at `https://veritycheck.vercel.app`. Use the settings button in the popup to point it at `http://localhost:5001` while developing locally.
